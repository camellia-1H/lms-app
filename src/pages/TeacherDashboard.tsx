...
import { faArrowRight, faChartSimple, faStar, faVideo, faUsers } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="dashboard w-11/12 mx-5 my-5">
      ...
      <div className='flex justify-between'>
        ...
        <div className='content-center'>
            ...
            <button type="submit" className="flex-none rounded-md bg-green-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-500">Search</button>
        </div>
      </div>
      <div className='flex justify-between mt-3'>
        <div className='rounded-lg bg-white w-1/4 mr-5 p-3'>
            <div className='flex items-center content-center'>
                <FontAwesomeIcon icon={faChartSimple} style={{ color: "#63E6BE", padding: "10px", backgroundColor: '#f3f3f3', borderRadius: "20px" }} className='text-xl mr-5 rounder'/>
                <div>
        ...
        <div className='rounded-lg bg-white w-1/4 mr-5 p-3'>
            <div className='flex items-center content-center'>
                <FontAwesomeIcon icon={faVideo} style={{ color: "#63E6BE", padding: "10px", backgroundColor: '#f3f3f3', borderRadius: "20px" }} className='text-xl mr-5 rounder'/>
                <div>
        ...
        <div className='rounded-lg bg-white w-1/4 mr-5 p-3'>
            <div className='flex justify-between items-center content-center'>
                <div className='flex justify-between items-center content-center'>
                    <FontAwesomeIcon icon={faUsers} style={{ color: "#63E6BE", padding: "10px", backgroundColor: '#f3f3f3', borderRadius: "20px" }} className='text-xl mr-5 rounder'/>
                    <div>
      ...
      <div className='w-2/4 bg-white p-3 rounded-lg'>
            <div className='px-5 pb-5 flex justify-between flex-col h-full'>
                ...
                <div className='flex flex-row-reverse content-center items-center text-lg text-green-500 hover:text-green-900 font-bold'>
                    <FontAwesomeIcon icon={faArrowRight} className='text-xl rounder'/>
            ...
            <div className='px-2 pb-5 flex justify-between flex-col h-full'>
                <div className='mt-5 flex justify-between flex-col'>
                    ...
                    <div className='flex justify-between items-center content-center border-l-4 border-green-500 rounder-sm px-3 my-2'>
                        <div>
                            <p className='font-bold'>Sir i'm asking about Xyz topics whe...</p>
